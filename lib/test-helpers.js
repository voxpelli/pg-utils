...
export class PgTestHelpers {
  ...
  constructor (options) {
    ...
    if (statementTimeoutMs !== undefined && (typeof statementTimeoutMs !== 'number' || !Number.isFinite(statementTimeoutMs))) {
      throw new TypeError('Invalid statementTimeoutMs, expected a finite number');
    }
    if (idleInTransactionTimeoutMs !== undefined && (typeof idleInTransactionTimeoutMs !== 'number' || !Number.isFinite(idleInTransactionTimeoutMs))) {
      throw new TypeError('Invalid idleInTransactionTimeoutMs, expected a finite number');
    }
