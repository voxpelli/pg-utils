...
/**
 * Fixed advisory lock ID for database locking (test isolation)
 * to the database during test runs. By using a fixed ID (42), we serialize operations that
 ...
 * @see {@link https://deepwiki.com/search/what-is-the-purpose-of-using-a_4fafdb58-310c-474f-aa85-6aaf5926bce3|Deepwiki answer}
 */
const LOCK_ID = 42;
